namespace Task6._2
{
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            new_person.CameToWork(new_person.PersonName, personQueue);
            second_person.CameToWork(second_person.PersonName, personQueue);
            third_person.CameToWork(third_person.PersonName, personQueue);
